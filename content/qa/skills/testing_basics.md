...
- Distinguish between test levels and test types classifications
- Distinguish between static and dynamic tests
- Differentiate between functional and non-functional tests
